      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-green-50 rounded-xl p-8 shadow-lg">
          <form className="space-y-6">
            <div>
              <label htmlFor="name" className="block text-green-800 font-medium mb-2">Nombre</label>
              <input 
                type="text" 
                id="name" 
            ...
            <div>
              <label htmlFor="email" className="block text-green-800 font-medium mb-2">Email</label>
              <input 
                type="email" 
                id="email" 
                className="w-full px-4 py-3 rounded-lg border border-green-200 focus:outline-none focus:ring-2 focus:ring-green-500"
            ...
            <div>
              <label htmlFor="message" className="block text-green-800 font-medium mb-2">Mensaje</label>
              <textarea 
                id="message" 
                rows="4" 
                className="w-full px-4 py-3 rounded-lg border border-green-200 focus:outline-none focus:ring-2 focus:ring-green-500"
